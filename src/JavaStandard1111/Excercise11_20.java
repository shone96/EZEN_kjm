...
public class Excercise11_20 {
	static ArrayList record = new ArrayList(); //성적데이터 저장
	...
	static int displayMenu() {
		...
		System.out.println();
		System.out.print("원하는 메류는 선택하세요. (1~3) : ");
	...
	static void inputRecord() {
		...
		System.out.println("입력을 마치려면 q를 입력하세요. 메인호면으로 돌아갑니다.");
	...
	static void displayRecord() {
		...
		if(length > 0) {
			...
			for(int i = 0; i < length; i++) {
				...
				matTotal += student.math;
				engTotal += student.eng;
				total += student.total;
			}
			System.out.println("=========================================");
			System.out.println("총점 : " + korTotal + " "+ engTotal + " "+ matTotal + " "+ total);
			System.out.println();
		}else {
			System.out.println("=========================================");
